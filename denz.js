...
try {
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© 𝗖𝗮𝗿𝗹𝗝𝗵𝗼𝗻𝘀𝗼𝗻✔︎_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_© 𝗖𝗮𝗿𝗹𝗝𝗵𝗼𝗻𝘀𝗼𝗻✔︎_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `𝗖𝗮𝗿𝗹𝗝𝗵𝗼𝗻𝘀𝗼𝗻✔︎`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/919947400040?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "𝗖𝗮𝗿𝗹𝗝𝗵𝗼𝗻𝘀𝗼𝗻✔︎", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'😱SHOW MENU'},type:1},
{buttonId:`owner`,buttonText:{displayText:'😎OWNER'},type:1},
{buttonId:`script`,buttonText:{displayText:'📃SCRIPT'},type:1}
...
╭─❒ 「 𝙰𝙱𝙾𝚄𝚃 𝙼𝙴 」 ❒──❒
│ ༄ 𝙽𝙰𝙼𝙴 : 𝙼𝙰𝙽𝚄
│ ༄ 𝙿𝙻𝙰𝙲𝙴 : 𝙼𝙰𝙻𝙰𝙻𝚄𝚁𝙰𝙼,𝙿𝙾𝙽𝙽𝙰𝙽𝙸
│ ༄ 𝙿𝙰𝚂𝚂𝙸𝙾𝙽 : 𝙶𝙰𝙼𝙸𝙽𝙶
│ ༄ 𝙸𝙽𝚂𝚃𝙰𝙶𝚁𝙰𝙼 : 𝚉𝚞𝚎𝚣.𝚎𝚍𝚒𝚝𝚣
│ ༄ 𝚂𝚃𝙰𝚃𝚄𝚂 : 𝚂𝙸𝙽𝙶𝙻𝙴 𝙻𝙸𝙵𝙴😱
└❏

╭─❒ 𝙱𝙾𝚃 𝙱𝚈 *𝗖𝗮𝗿𝗹𝗝𝗵𝗼𝗻𝘀𝗼𝗻✔︎*
│
├➫ 𝚂𝚌𝚛𝚒𝚙𝚝 𝚌𝚑𝚘𝚍𝚒𝚌𝚑𝚞 𝚙𝚖 𝚟𝚊𝚛𝚊𝚗𝚍𝚊🐦
│
├➫ 𝙿𝚁𝙸𝚅𝙰𝚃𝙴 𝙱𝙾𝚃 𝙰𝙽𝙽 𝙼𝚆𝙾𝙽𝙴
│
├➫ 𝙷𝙴𝙻𝙿𝙴𝙳 𝙱𝚈 𝙰𝙽𝙴𝙴𝚂 𝚂𝙴𝚁 ❣️
│
├➫ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁 : *𝗖𝗮𝗿𝗹𝗝𝗵𝗼𝗻𝘀𝗼𝗻✔︎*
│
...
├➫ *𝗖𝗮𝗿𝗹𝗝𝗵𝗼𝗻𝘀𝗼𝗻✔︎*
└─────────────────❒`
sendButLocation(from, `${menu}`, "𝗖𝗮𝗿𝗹𝗝𝗵𝗼𝗻𝘀𝗼𝗻✔︎", {jpegThumbnail:gambar,name:""}, [{buttonId:`owner`,buttonText:{displayText:'🐦OWNER'},type:1},{buttonId:`script`,buttonText:{displayText:'📒SCRIPT'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'menu':
 stod = `${sender}`
 listMsg = {
 buttonText: '𝙻𝙸𝚂𝚃 𝙼𝙴𝙽𝚄⁩',
 footerText: '*_© 𝗖𝗮𝗿𝗹𝗝𝗵𝗼𝗻𝘀𝗼𝗻✔︎_*',
       ...
       case 'maker2d2': 
		...
		case 'maker2d4': 
			...
			case 'transformer': 
					...
					break
			case 'googletxt':
                    if (args.length < 1) return reply(`*Example :*\n${prefix}${command} 𝙲𝙰𝚁𝙻|𝙹𝙷𝙾𝙽𝚂𝙾𝙽|𝙱𝙾𝚃`)
					makell = args.join(" ")
					ll1 = makell.split("|")[0];
					ll2 = makell.split("|")[1];
					ll3 = makell.split("|")[0];
...
case 'tts':
         ...
         break
			...
			if (!isOwner && !isGroupAdmins) return reply(mess.only.admin)
					...
					if (Number(args[0]) === 1) {
						if (isWelkom) return reply('𝙰𝙻𝚁𝙴??𝙳𝚈 𝙰𝙲𝚃𝙸𝚅𝙴')
						welkom.push(from)
