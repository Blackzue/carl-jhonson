...
try {
        ...
        mess = {
			...
			only: {
				...
				ownerB: '𝙾𝙽𝙻𝚈 𝙵𝙾𝚁 ꪶ𝐂𝐀𝐑𝐋 ≛ 𝐉𝐇𝐎𝐍𝐒𝐎𝐍䘜⇝',
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© ꪶ𝐂𝐀𝐑𝐋 ≛ 𝐉𝐇𝐎𝐍𝐒𝐎𝐍䘜⇝_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_© ꪶ𝐂𝐀𝐑𝐋 ≛ 𝐉𝐇𝐎𝐍𝐒𝐎𝐍䘜⇝_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ꪶ𝐂𝐀𝐑𝐋 ≛ 𝐉𝐇𝐎𝐍𝐒𝐎𝐍䘜⇝`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/919947400040?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
...
console.log(color('[EVAL]'), color(moment(mek.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'yellow'), color(`Carl V1 brooo`))
ras = budy.slice(1)
function _(rem) {
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "ꪶ𝐂𝐀𝐑𝐋 ≛ 𝐉𝐇𝐎𝐍𝐒𝐎𝐍䘜⇝", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'😱SHOW MENU'},type:1},
{buttonId:`owner`,buttonText:{displayText:'😎OWNER'},type:1},
{buttonId:`script`,buttonText:{displayText:'📃SCRIPT'},type:1}
...
╭─❒ 「 𝙰𝙱𝙾𝚄𝚃 𝙼𝙴 」 ❒──❒
│ ༄ 𝙽𝙰𝙼𝙴 : 𝙼𝙰𝙽𝚄
│ ༄ 𝙿𝙻𝙰𝙲𝙴 : 𝙼𝙰𝙻𝙰𝙿𝚄𝚁𝙰𝙼,𝙿𝙾𝙽𝙽𝙰𝙽𝙸
│ ༄ 𝙿𝙰𝚂𝚂𝙸𝙾𝙽 : 𝙶𝙰𝙼𝙸𝙽𝙶,𝙴𝙳𝙸𝚃𝙸𝙽𝙶
│ ༄ 𝙸𝙽𝚂𝚃𝙰𝙶𝚁𝙰𝙼 : 𝚉𝚄𝙴𝚉.𝙴𝙳𝙸𝚃𝚉
│ ༄ 𝚂𝚃𝙰𝚃𝚄𝚂 : 𝚂𝙸𝙽𝙶𝙻𝙴 𝙻𝙸𝙵𝙴😱
└❏

╭─❒ 𝙱𝙾𝚃 𝙱𝚈 *ꪶ𝐂𝐀𝐑𝐋 ≛ 𝐉𝐇𝐎𝐍𝐒𝐎𝐍䘜⇝*
│
├➫ 𝚂𝚌𝚛𝚒𝚙𝚝 𝚌𝚑𝚘𝚍𝚒𝚌𝚑𝚞 𝚙𝚖 𝚟𝚊𝚛𝚊𝚗𝚍𝚊🐦
│
├➫ 𝙿𝚁𝙸𝚅𝙰𝚃𝙴 𝙱𝙾𝚃 𝙰𝙽𝙽 𝙼𝚆𝙽𝙾𝙴
│
├➫ 𝙷𝙴𝙻𝙿𝙴𝙳 𝙱𝚈 𝙰𝙽𝙴𝙴𝚂 𝚂𝙴𝚁 ❣️
│
├➫ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁 : *ꪶ𝐂𝐀𝐑𝐋 ≛ 𝐉𝐇𝐎𝐍𝐒𝐎𝐍䘜⇝*
│
├➫ 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙼𝙴 : wa.me/919947400040
│
├➫ 𝚄𝚂𝙴 𝙼𝙴𝙽𝚄✰
│
├➫ .allmenu
...
├➫ *ꪶ𝐂𝐀𝐑𝐋 ≛ 𝐉𝐇𝐎𝐍𝐒𝐎𝐍䘜⇝*
└─────────────────❒`
sendButLocation(from, `${menu}`, "ꪶ𝐂𝐀𝐑𝐋 ≛ 𝐉𝐇𝐎𝐍𝐒𝐎𝐍䘜⇝", {jpegThumbnail:gambar,name:""}, [{buttonId:`owner`,buttonText:{displayText:'🐦OWNER'},type:1},{buttonId:`script`,buttonText:{displayText:'📒SCRIPT'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'menu':
 stod = `${sender}`
 listMsg = {
 buttonText: '𝙻𝙸𝚂𝚃 𝙼𝙴𝙽𝚄⁩',
 footerText: '*_© ꪶ𝐂𝐀𝐑𝐋 ≛ 𝐉𝐇𝐎𝐍𝐒𝐎𝐍䘜⇝_*',
 description: `𝙷𝙸 𝙱𝚁𝙾 @${stod.split('@')[0]}, 𝚃𝙷𝙸𝚂 𝙸𝚂 𝙻𝙸𝚂𝚃 𝙼𝙴𝙽𝚄`,
 sections: [
                     {
                      "title": `ꪶ𝐂𝐀𝐑𝐋 ≛ 𝐉𝐇𝐎𝐍𝐒𝐎𝐍䘜⇝`,
 rows: [
                          {
                              "title": "Script",
                              "rowId": ""
...
client.browserDescription = ['Carl','Edge','3.0']
...
└ ${prefix}ytmp4 [link yt] = Video`})
			...
			case 'ping':
				...
				if (!isOwner) return reply(mess.only.ownerB)
					...
					if (err) return denz.sendMessage(from, `root @Manu-Ser:~ ${err}`, text, { quoted: mek })
                 break
                 case 'toimg':
				case 'tomedia':
